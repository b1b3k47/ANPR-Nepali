...
def onBrowse(event):
    ...
    imgBig = wx.Image(320, 427)
    imgPlates= wx.Image(344,200)
    imgChar= wx.Image(100,100)
...
def onView():
    ...
    img2= img.Scale(320, 427, wx.IMAGE_QUALITY_HIGH)
...
def display_lp_skewed(Image_Path):
    ...
    img2= lp_display.Scale(344,200, wx.IMAGE_QUALITY_HIGH)
...
if __name__ == '__main__':
    ...
    frame = wx.Frame(None, -1, 'Project Bibek Khanal Nepali Number Recognition 075MSICE002', size=(1920, 1080))
    ...
    img_lp_skewed = wx.Image(344, 200)
    lp_skewed_imageCtrl = wx.StaticBitmap(panel, wx.ID_ANY, wx.Bitmap(img_lp_skewed), pos=(810, 550), style = wx.SUNKEN_BORDER)

    # Creating a Bitmap to hold Segmented and de-skewed License Plate
    img_lp_deskewed = wx.Image(344, 200)
    lp_deSkewed_imageCtrl = wx.StaticBitmap(panel, wx.ID_ANY, wx.Bitmap(img_lp_deskewed), pos=(1180, 550), style = wx.SUNKEN_BORDER)

    # Creating a Bitmap to hold Segmented License Plate with Segmented Characters
    img_license_plate = wx.Image(344, 200)
    License_plateImgCtrl = wx.StaticBitmap(panel, wx.ID_ANY, wx.Bitmap(img_license_plate), pos=(1550, 550), style = wx.SUNKEN_BORDER)
